...
export const relatedSkills = [
   ...
   { skill: "Django", lvl: "good" },
   { skill: "Java", lvl: "good" },
   { skill: "React Native", lvl: "okay" },
   { skill: "Kotlin", lvl: "okay" },
   { skill: "NoSQL (Mongo, Dynamo)", lvl: "great" },
   { skill: "SQL (Postgres, MySQL)", lvl: "great" },
   { skill: "CSS/SCSS", lvl: "great" },
   { skill: "Tailwind", lvl: "great" },
   { skill: "Dev Ops (GCP, Vercel)", lvl: "great" },
   { skill: "Github / Git", lvl: "great" },
   { skill: "ORMs (Sequelize, Prisma, etc)", lvl: "great" },
];
